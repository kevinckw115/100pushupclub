...
Implementation is now merged into main via PR #1. For this existing checkout, follow [current progress](tracking/PROGRESS.md) and the [beta setup checklist](docs/13-beta-review.md); do not scaffold over apps/mobile again. The original package-start instructions below describe the initial handoff.
